                            ...
                            <div class="modal-content">
                                <form method="POST" action="{{ route('admin.extensions.update', $ext['extension']) }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">New SIP Password <small class="text-muted">(leave blank to keep current)</small></label>
            ...
            <form method="POST" action="{{ route('admin.extensions.store') }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">
                        ...
                        <small class="text-muted fs-6">— {{ $selectedUcm->name }}</small>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Extension Number <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">User Portal Password <span class="text-danger">*</span></label>
